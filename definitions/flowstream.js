...
ON('ready', function() {
	...
	PATH.fs.readFile(PATH.join(DIRECTORY, DB_FILE), function(err, data) {
		...
		if (!FS.db.tms)
			FS.db.tms = { author: '', color: '', components: {}, design: {}, dtcreated: NOW,group: '', icon: 'fas fa-microchip', id: 'tms', name: 'TMS', readme: '', reference: '', sources: {}, url: 'https://www.totaljs.com', variables: {}, variables2: {}, version: '' };
